...
func (e *Exporter) scrapeADC(ch chan<- prometheus.Metric) map[string]bool {
	...
	run("ns_stats", func() bool {
		...
		ch <- prometheus.MustNewConstMetric(e.totRxMB, prometheus.CounterValue, fltTotRxMB, baseLabels...)
		ch <- prometheus.MustNewConstMetric(e.totTxMB, prometheus.CounterValue, fltTotTxMB, baseLabels...)
		ch <- prometheus.MustNewConstMetric(e.httpRequests, prometheus.CounterValue, fltHTTPRequests, baseLabels...)
		ch <- prometheus.MustNewConstMetric(e.httpResponses, prometheus.CounterValue, fltHTTPResponses, baseLabels...)
